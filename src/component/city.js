...
class CitySelect extends Component {
                ...
                <View style={cityStyle.title}>
                    <TouchableOpacity
                        ...
                        <Image style={cityStyle.backIcon}
                               source={require('../static/icon/order.jpg')}/>
                    </TouchableOpacity>
        ...
        return (
            <View>
                <FlatList
                    ...
                    numColumns={4}
                    showsHorizontalScrollIndicator={false}
                    renderItem={({item}) => this._createItem.call(this, item)}
     ...
     */
    _itemClick (item) {
        this.props.route.params.callback(item.city)
